...
class guide_mitms_create_organisation_custom_fields_step extends guide_default_step {
    ...
    function content_step_pending () {
        return '<p>Use Custom fields to capture specific information for an organisation. You can set up custom fields without having any custom field categories set up.</p>';
    }
    ...
    function content_step_complete () {
        return '<p>This step has been completed.</p>
            <p>You can set up more custom fields at any stage by clicking the <b>Custom field</b> button on any depth level.</p>';
    }
