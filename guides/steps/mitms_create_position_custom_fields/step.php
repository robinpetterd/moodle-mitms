...
class guide_mitms_create_custom_fields_step extends guide_default_step {
    ...
    function content_step_pending () {
        return '<p>Use Custom fields to capture specific information for a competency. You can set up custom fields without having any custom field categories set up.</p>';
    }
