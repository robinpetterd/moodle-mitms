...
class guide_mitms_create_position_custom_field_categories_step extends guide_default_step {
    ...
    function content_step_pending () {
        return '<p>Custom field categories can be set up for each depth level.</p>
            <p>Custom field categories allow you to group custom fields on the Add new competency page.</p>';
    }
