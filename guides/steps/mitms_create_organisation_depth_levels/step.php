...
class guide_mitms_create_organisation_depth_levels_step extends guide_default_step {
    ## Return the content the step should display when it is the active step in a guide:
    function content_step_active () {
        return '<p>This step requires you to set up a depth level under your organisational framework.</p>
            <p>When you are ready to start open the framework you created and click the <b>Add a new depth level</b> button</a>.</p>
            <p>Refer to the ' .
            mitms_captivate_popup('Setting up Depth Levels help file', 'setting up depth levels') .
    ...
    function content_step_pending () {
        return '<p>An organisational framework requires at least one depth level to be set up.</p>
            <p>Depth levels allow you to set up a hierarchical structure for the organisation framework.</p>';
    }
    ...
    function content_step_complete () {
        return '<p>This step has been completed. </p>
            <p>You can set up more depth levels at any stage by clicking <b>Add a depth level</b> from the Manage organisation framework screen.</p>';
    }
